...
# running ripple 3 times gets to final output
...
############
# reverse A01, A02, A04, A05, A06, A07, A08, A10
############
...
b_map_red <- switch.order(b_map_red, chr = "A05", order = chr5)
markernames(b_map_red, chr='A05')
